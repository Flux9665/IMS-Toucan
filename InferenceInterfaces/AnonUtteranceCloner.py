...
from IMSToucan.InferenceInterfaces.InferenceFastSpeech2 import InferenceFastSpeech2
...
from IMSToucan.TrainingInterfaces.Text_to_Spectrogram.AutoAligner.Aligner import Aligner
from IMSToucan.TrainingInterfaces.Text_to_Spectrogram.FastSpeech2.DurationCalculator import DurationCalculator
from IMSToucan.TrainingInterfaces.Text_to_Spectrogram.FastSpeech2.EnergyCalculator import EnergyCalculator
from IMSToucan.TrainingInterfaces.Text_to_Spectrogram.FastSpeech2.PitchCalculator import Parselmouth


class AnonUtteranceCloner:

    def __init__(self, device: str, path_to_fastspeech_model: str, path_to_hifigan_model: str, path_to_aligner_model: str):
    ...
    def extract_prosody(self, transcript, ref_audio_path, lang="de", on_line_fine_tune=True, input_phonemes=False):
        ...
        text = tf.string_to_tensor(transcript, handle_missing=False, input_phonemes=input_phonemes).squeeze(0)
...
if __name__ == '__main__':
    uc = AnonUtteranceCloner(model_id="Meta", device="cuda" if torch.cuda.is_available() else "cpu")
